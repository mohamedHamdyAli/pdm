...
function saveBookingActivity($data)
{
    ...
    switch ($data['activity_type'])
    {
        case "add_booking":
                ...
                $data['activity_message_ar'] ='تمت إضافة حجز جديد بواسطة العميل';
                $data['activity_type_ar'] = 'تم إضافة حجز جديد';
                $activity_data = [
        ...
        case "assigned_booking":
                ...
                $data['activity_message_ar'] = ' تم تعيين الحجز إلى ' . $assigned_handyman;
                $data['activity_type_ar'] = 'تم تعيين الحجز';
                $activity_data = [
        ...
        case "transfer_booking":
                $assigned_handyman = handymanNames($data['booking']->handymanAdded);
                $data['activity_type_ar'] = 'تم نقل الحجز';
                $data['activity_message_ar'] =  ' تم نقل الحجز إلى ' . $assigned_handyman  ;
        ...
        case "update_booking_status":
                ...
                $status_ar = \App\Models\BookingStatus::bookingStatus_ar($data['booking']->status);
                $old_status = \App\Models\BookingStatus::bookingStatus($data['booking']->old_status);
                $old_status_ar = \App\Models\BookingStatus::bookingStatus_ar($data['booking']->old_status);
                $data['activity_message'] = __('messages.booking_status_update',[ 'from' => $old_status , 'to' => $status ]);
                $data['activity_message_ar'] =  ' تم تغيير حالة الحجز من ' . $old_status_ar . ' إلى ' . $status_ar  ;
                $data['activity_type_ar'] = 'تم تغيير حالة الحجز';
                $activity_data = [
        ...
        case "cancel_booking":
            ...
            $data['activity_message_ar'] = 'تم إلغاء الحجز ';
            $data['activity_type_ar'] = 'تم إلغاء الحجز';
            $activity_data = [
                'reason' => $data['booking']->reason,
                'status' => $data['booking']->status,
        ...
        case "payment_message_status" :
            ...
            $data['activity_message_ar'] =   ' الدفع الخاص بك هو '. $data['payment_status']  ;
            $data['activity_type_ar'] = 'حالة الدفع ';
            $activity_data = [
    ...
    $notification_data = [
        ...
        'type_ar' => $data['activity_type_ar'],
        'subject' => $data['activity_type'],
        'message' => $data['activity_message'],
        'message_ar' => $data['activity_message_ar'],
...
function savePayoutActivity($data)
{
    switch ($data['type'])
    {
        case "provider_payout":
                ...
                $data['activity_message_ar'] =  'دفع المشرف  ' . $data['amount'] . ' لك ' ;
                $data['activity_type_ar'] =  'دفع المشرف  ';
                $activity_data = [
        ...
        case "handyman_payout":
                ...
                $data['activity_message_ar'] =  'دفع المزود  ' . $data['amount'] . ' لك ' ;
                $data['activity_type_ar'] =  'دفع المزود  ';
                $activity_data = [
                    'user_id' =>$data['user_id'],
                    'amount' => $data['amount'],
                ];
...
function saveWalletHistory($data){
    ...
    switch ($data['activity_type'])
    {
        case "add_wallet":
                ...
                $data['activity_message_ar'] =  'تمت إضافة المحفظة' ;
                $data['activity_type_ar'] =  'تمت إضافة المحفظة' ;
        ...
        case "update_wallet":
                ...
                $data['activity_message_ar'] =  'تم تعديل المحفظة' ;
                $data['activity_type_ar'] =  'تم تعديل المحفظة' ;
                $activity_data = [
                    'title' => $data['wallet']->title,
                    'user_id' => $data['wallet']->user_id,
                    'provider_name' => isset($data['wallet']->provider) ? $data['wallet']->provider->display_name : '',
        ...
        case "wallet_payout_transfer":
            ...
            $data['activity_message_ar'] =  'مبلغ المحفظة  ' . $data['wallet']  ;
            $data['activity_type_ar'] =  'المبلغ الموجود بالمحفظة' ;
            $activity_data = [
                'title' => $data['wallet']->title,
                'user_id' => $data['wallet']->user_id,
                'provider_name' => isset($data['wallet']->provider) ? $data['wallet']->provider->display_name : '',
