...
class AppSetting extends Model implements HasMedia
{
    ...
    protected $fillable = ['site_name','site_name_en', 'site_email', 'site_logo', 'site_favicon','site_description','site_description_en','site_copyright','facebook_url','twitter_url','linkedin_url' , 'language_option','inquriy_email','helpline_number','instagram_url','youtube_url','time_zone','earning_type'];
