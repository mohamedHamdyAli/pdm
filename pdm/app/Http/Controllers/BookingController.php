...
class BookingController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $bookingdata = Booking::find($id);
        $bookservice = Bookingservice::select('services.name', 'services.price', 'services.type','bookingservices.quantity','bookingservices.amount')
        ->join('services', 'bookingservices.service_id', '=', 'services.id')
        ->where('bookingservices.booking_id', 'like', '%' . $id . '%')
        ->get();
        ...
        return view('booking.view', compact('pageTitle' ,'bookingdata' ,'auth_user', 'bookservice' ));
    }
