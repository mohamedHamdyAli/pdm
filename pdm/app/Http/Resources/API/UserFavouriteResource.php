...
class UserFavouriteResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'name' => $request->input('lang') == 'en' ? optional($this->service)->name_en : optional($this->service)->name,
            'description' => $request->input('lang') == 'en' ? optional($this->service)->description_en : optional($this->service)->description,
