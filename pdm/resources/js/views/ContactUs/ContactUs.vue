<template>
    <div>
        ...
        <section class="map-box mar-top">
             <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=40.7127837,-74.0059413&amp;key=AIzaSyCHJwjZjGSOBc18-3mJM8tCqDYoV3Nk9tQ"></iframe>
        </section>
    </div>
</template>
<script>
