                    ...
                    <div class="card-body">
                        {{ Form::model($servicedata,['method' => 'POST','route'=>'service.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'service'] ) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{ Form::label('name_en',__('messages.name_en').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::text('name_en',old('name_en'),['placeholder' => __('messages.name_en'),'class' =>'form-control','required']) }}
                                    <small class="help-block with-errors text-danger"></small>
                                </div>
 ...
 --}}
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="service_attachment" class="custom-file-input" data-file-error="{{ __('messages.files_not_allowed') }}" id="service_attachment_image">
                                ...
                                <div class="row service_attachment_div">
                                    ...
                                    @if(getMediaFileExit($servicedata, 'service_attachment'))
                                        ...
                                        <div class="border-left-2">
                                            ...
                                            <div class="ml-2 mt-3 service_attachment_dib">
                                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    {{ Form::label('description_en',__('messages.description_en'), ['class' => 'form-control-label']) }}
                                    {{ Form::textarea('description_en', null, ['class'=>"form-control textarea" , 'rows'=>3  , 'placeholder'=> __('messages.description_en') ]) }}
                                </div>
                            ...
                            {{ Form::submit( __('messages.save'), ['class'=>'btn btn-md btn-primary float-right service_attachment_btn']) }}
                        {{ Form::close() }}
                    </div>
                </div>
            </div>
...
$(document).ready(function (){
    $(".service_attachment_btn").click(function(e) {


        var fileInput = $.trim($("#service_attachment_image").val());
        if (fileInput && fileInput !== '') {
            if ($(".service_attachment_dib").find(".row").length > 0){
                e.preventDefault();
                // $('.remove-file')[0].click();
                alert("Please Reomove *ATTACHED FILES* First To Update New Image");
            } else {}
