                    ...
                    <div class="card-body">
                        {{ Form::model($sliderdata,['method' => 'POST','route'=>'slider.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'slider'] ) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{ Form::label('title_en',__('messages.title_en').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::text('title_en',old('title_en'),['placeholder' => __('messages.title_en'),'class' =>'form-control','required']) }}
                                    <small class="help-block with-errors text-danger"></small>
                                </div>
