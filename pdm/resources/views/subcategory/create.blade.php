                    ...
                    <div class="card-body">
                        {{ Form::model($subcategory,['method' => 'POST','route'=>'subcategory.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'subcategory'] ) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{ Form::label('name_en',trans('messages.name_en').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::text('name_en',old('name_en'),['placeholder' => trans('messages.name_en'),'class' =>'form-control','required']) }}
                                    <small class="help-block with-errors text-danger"></small>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    {{ Form::label('description_en',trans('messages.description_en'), ['class' => 'form-control-label']) }}
