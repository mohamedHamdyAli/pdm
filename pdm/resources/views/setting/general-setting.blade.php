...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="form-group">
            <label for="" class="col-sm-6 form-control-label">{{ __('messages.site_name_en') }}</label>
            <div class="col-sm-12">
                {{ Form::text('site_name_en', null, ['class'=>"form-control" ,'placeholder'=> __('messages.site_name_en') ]) }}
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="" class="col-sm-6 form-control-label">{{ __('messages.site_description_en') }}</label>
            <div class="col-sm-12">
                {{ Form::textarea('site_description_en', null, ['class'=>"form-control textarea" , 'rows'=>3  , 'placeholder'=> __('messages.site_description_en')]) }}
            </div>
        </div>
