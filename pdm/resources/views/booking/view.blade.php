                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="d-flex flex-column booking-service col-md-9 ">
                                            <div class="row">
                                                <div class="col-8"><b>{{__('messages.service')}}</b></div>
                                                <div class="col-2"><b style="font-size: 15px">{{__('messages.quantity')}}</b></div>
                                                <div class="col-2"><b>{{__('messages.duration')}}</b></div>
                                            </div>

                                            <span>

                                                @foreach($bookservice as $bookserv)
                                                <div class="row" style="border-bottom: 1px solid#e9e9e9; padding: 10px 0;}">
                                                    <div class="col-8">
                                                        <small>{{$bookserv->name}}
                                                       </small>
                                                    </div>
                                                    <div class="col-2">
                                                        <small>{{$bookserv->quantity}}
                                                       </small>
                                                    </div>
                                                    <div class="col-2">
                                                        <small>{{$bookserv->type}}
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <p>{{ isset($bookingdata->service) ? getPriceFormat($bookingdata->total_amount) : 0 }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
