                    ...
                    <div class="card-body">
                        {{ Form::model($plan,['method' => 'POST','route'=>'plans.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'plan'] ) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    {{ Form::label('title_en',trans('messages.title_en').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::text('title_en',old('title_en'),['placeholder' => trans('messages.title_en'),'class' =>'form-control','required']) }}
                                    <small class="help-block with-errors text-danger"></small>
                                </div>
                                <div class="form-group col-md-3">
